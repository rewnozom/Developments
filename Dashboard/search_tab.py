...
class SearchTab(QWidget):
    ...
    """
    def __init__(self, json_directory="./Dashboard/json/"):
        super().__init__()
    ...
    def initUI(self):
        ...
        left_panel.setStyleSheet("""
            QFrame { background-color: #1C1C1C; border: 2px solid #333333; border-radius: 10px; }
        """)
        ...
        toolbox_panel.setStyleSheet("""
            QFrame {
                background-color: #1C1C1C; border: 1px solid #333333; border-radius: 8px; padding: 10px;
            }
