...
class Config:
    def __init__(self):
        ...
        # API keys
        self.OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "your_api_key_here")
        self.API_KEY_ANTHROPIC = os.getenv("API_KEY_ANTHROPIC", "your_api_key_here")
        self.API_KEY_GROQ = os.getenv("API_KEY_GROQ", "your_api_key_here")
        self.MISTRAL_API_KEY = os.getenv("MISTRAL_API_KEY", "your_api_key_here")
